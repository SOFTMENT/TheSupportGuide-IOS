//
//  FranchiseTabbarViewController.swift
//  The Support Guide
//
...
class FranchiseTabbarViewController : UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let selectedImage2 = UIImage(named: "briefcase-3")?.withRenderingMode(.alwaysOriginal)
        let deSelectedImage2 = UIImage(named: "briefcase-2")?.withRenderingMode(.alwaysOriginal)
        tabBarItems = self.tabBar.items![1]
        tabBarItems.image = deSelectedImage2
        tabBarItems.selectedImage = selectedImage2
        
        let selectedImage3 = UIImage(named: "money-bag-2")?.withRenderingMode(.alwaysOriginal)
        let deSelectedImage3 = UIImage(named: "money-bag")?.withRenderingMode(.alwaysOriginal)
        tabBarItems = self.tabBar.items![2]
        tabBarItems.image = deSelectedImage3
        tabBarItems.selectedImage = selectedImage3
        

        let selectedImage4 = UIImage(named: "more-5")?.withRenderingMode(.alwaysOriginal)
        let deSelectedImage4 = UIImage(named: "more-4")?.withRenderingMode(.alwaysOriginal)
