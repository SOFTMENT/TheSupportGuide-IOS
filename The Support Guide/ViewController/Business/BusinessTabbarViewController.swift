...
class BusinessTabbarViewController : UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let selectedImage2 = UIImage(named: "coupon-8")?.withRenderingMode(.alwaysOriginal)
        let deSelectedImage2 = UIImage(named: "coupon-7")?.withRenderingMode(.alwaysOriginal)
        ...
        let selectedImage4 = UIImage(named: "info-2")?.withRenderingMode(.alwaysOriginal)
        let deSelectedImage4 = UIImage(named: "info")?.withRenderingMode(.alwaysOriginal)
